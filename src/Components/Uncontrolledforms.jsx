...
function Uncontrolledforms(props) {
 let pname=useRef()
 let pbrand=useRef()
 let price=useRef()
 let pcat=useRef()
    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                <div>Product name:<input type="text" ref={pname}/></div>
                <div>Product brand:<input type="text" ref={pbrand}/></div>
                <div>Product price:<input type="text" ref={price}/></div>
                <div>Product category:<input type="text" ref={pcat}/></div>
